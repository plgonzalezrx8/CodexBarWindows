...
public class CliExecutionHelper : ICommandRunner
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        catch (OperationCanceledException)
        {
            ...
            return new CommandResult(-1, outputBuilder.ToString(), AppendTimeoutError(errorBuilder.ToString()));
        }
        catch (Exception ex)
        {
            return new CommandResult(-2, string.Empty, ex.Message);
        }
    }
